    ...
    <div class="container">
     ...
     <div class="container1">
        <div class="city-container">
            <div class="search">
                <div class="city-input">
                    <input type="text" placeholder="Enter City Name" id="cityInput3">
                    <button class="searchBtn" onclick="getWeather(3)">Search</button>
                </div>
            </div>
            <div class="error" style="display: none;">
                <p>Invalid City Name</p>
            </div>
            <div class="weather city3">
                <!-- Weather data for the third city will be displayed here -->
            </div>
            <div class="air-pollution city3">
                <!-- Air pollution data for the third city will be displayed here -->
            </div>
        </div>
        ...
        <div class="city-container">
            <div class="search">
                <div class="city-input">
                    <input type="text" placeholder="Enter City Name" id="cityInput4">
                    <button class="searchBtn" onclick="getWeather(4)">Search</button>
                </div>
            </div>
            <div class="error" style="display: none;">
                <p>Invalid City Name</p>
            </div>
            <div class="weather city4">
                <!-- Weather data for the fourth city will be displayed here -->
            </div>
            <div class="air-pollution city4">
                <!-- Air pollution data for the fourth city will be displayed here -->
            </div>
        </div>
    </div>
