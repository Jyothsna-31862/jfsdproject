      ...
      <a class="navbar-brand" href="#"><i class="fas fa-city"></i> SMART CITY</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto"> <!-- Use 'mx-auto' to center the items -->
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="tourism.jsp"> Tourism</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="contactus"> Contact</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="file1.html">Climate</a>
                </li>
                <li class="nav-item">
...
<script type="text/javascript">
  ...
  window.__be.id = "6546b80aead94500074dfa16";
  (function() {
